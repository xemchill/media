...
doMakeFixed = function(id, params) {
    ...
    $(window).bind("scroll", function(event) {
        var B0 = 0;
        if (typeof(params) == "undefined" || typeof(params.bottom) == "undefined") B0 = 0;
        else if (typeof(params.bottom) == "string") B0 = $(params.bottom).offset().top;
        else B0 = params.bottom;
        var b = $(window).scrollTop() + e.H0;
